...
//
// define orm of compo
$iteminfo['orm'][] = array('module' => 'xoonips', 'name' => 'item_basic',      'field' => 'basic',       'foreign_key' => 'item_id', 'multiple' => false);
$iteminfo['orm'][] = array('module' => 'xoonips', 'name' => 'title',           'field' => 'titles',      'foreign_key' => 'item_id', 'multiple' => true, 'required' => true);
$iteminfo['orm'][] = array('module' => 'xoonips', 'name' => 'keyword',         'field' => 'keywords',    'foreign_key' => 'item_id', 'multiple' => true);
$iteminfo['orm'][] = array('module' => 'xoonips', 'name' => 'index_item_link', 'field' => 'indexes',     'foreign_key' => 'item_id', 'multiple' => true);
$iteminfo['orm'][] = array('module' => 'xoonips', 'name' => 'related_to',      'field' => 'related_tos', 'foreign_key' => 'parent_id', 'multiple' => true);
$iteminfo['orm'][] = array('module' => 'xoonips', 'name' => 'changelog',       'field' => 'changelogs',  'foreign_key' => 'item_id', 'multiple' => true);
...
$iteminfo['io']['xmlrpc']['item'][] = array('orm' => array('field' => array(array('orm' => 'basic',    'field' => 'item_id'))),
                                             'xmlrpc' => array('field' => array('item_id'),
                                                                ...
                                                                'multiple' => false,
                                                                'readonly' => true, ), );
$iteminfo['io']['xmlrpc']['item'][] = array('orm' => array('field' => array(array('orm' => 'basic',    'field' => 'item_type_id'))),
                                             'xmlrpc' => array('field' => array('itemtype'),
                                                                'display_name' => '_MD_XOONIPS_XMLRPC_DISPLAY_NAME_ITEMTYPE',
                                                                'type' => 'string',
                                                                'multiple' => false,
                                                                'required' => true,
                                                                'readonly' => true, ), );
$iteminfo['io']['xmlrpc']['item'][] = array('orm' => array('field' => array(array('orm' => 'basic',    'field' => 'uid'))),
                                             'xmlrpc' => array('field' => array('username'),
                                                                ...
                                                                'required' => false,
                                                                'readonly' => true, ),
                                             'eval' => array('orm2xmlrpc' => '$user_handler =& xoops_gethandler( "user" ); $user =& $user_handler->get($in_var[0]); if( $user ) $out_var[0] = $user->getVar( "uname", "none" );',
...
$iteminfo['io']['xmlrpc']['item'][] = array('orm' => array('field' => array(array('orm' => 'titles',   'field' => 'title'),
                                             ...
                                             'xmlrpc' => array('field' => array('titles'),
                                                                ...
                                                                'multiple' => true,
                                                                'required' => true, ),
                                             'eval' => array('orm2xmlrpc' => '$out_var[0] = $in_var[0];',
                                                              'xmlrpc2orm' => 'if( strlen( trim($in_var[0]) ) > 0 ){ $out_var[0] = trim($in_var[0]); $out_var[1] = $context["position"]; }', ), );
$iteminfo['io']['xmlrpc']['item'][] = array('orm' => array('field' => array(array('orm' => 'keywords', 'field' => 'keyword'),
                                                                               array('orm' => 'keywords', 'field' => 'keyword_id'), )),
                                             'xmlrpc' => array('field' => array('keywords'),
...
$iteminfo['io']['xmlrpc']['item'][] = array('orm' => array('field' => array(array('orm' => 'basic',    'field' => 'description'))),
                                             'xmlrpc' => array('field' => array('comment'),
                                                                'display_name' => '_MD_XOONIPS_XMLRPC_DISPLAY_NAME_DESCRIPTION',
                                                                'type' => 'string',
                                                                'multiple' => false, ), );
$iteminfo['io']['xmlrpc']['item'][] = array('orm' => array('field' => array(array('orm' => 'basic',    'field' => 'doi'))),
                                             'xmlrpc' => array('field' => array('ext_id'),
                                                                'display_name' => '_MD_XOONIPS_XMLRPC_DISPLAY_NAME_EXT_ID',
                                                                'type' => 'string',
                                                                'multiple' => false, ), );
$iteminfo['io']['xmlrpc']['item'][] = array('orm' => array('field' => array(array('orm' => 'basic',    'field' => 'last_update_date'))),
                                             'xmlrpc' => array('field' => array('last_modified_date'),
                                                                'display_name' => '_MD_XOONIPS_XMLRPC_DISPLAY_NAME_LAST_MODIFIED_DATE',
                                                                'type' => 'dateTime.iso8601',
                                                                'readonly' => true, ), );
$iteminfo['io']['xmlrpc']['item'][] = array('orm' => array('field' => array(array('orm' => 'basic',    'field' => 'creation_date'))),
                                             'xmlrpc' => array('field' => array('registration_date'),
                                                                'display_name' => '_MD_XOONIPS_XMLRPC_DISPLAY_NAME_REGISTRATION_DATE',
                                                                'type' => 'dateTime.iso8601',
                                                                'readonly' => true, ), );
$iteminfo['io']['xmlrpc']['item'][] = array('orm' => array('field' => array(array('orm' => 'basic', 'field' => 'publication_year'))),
                                             'xmlrpc' => array('field' => array('creation_year'),
                                                                'display_name' => '_MD_XOONIPS_XMLRPC_DISPLAY_NAME_CREATION_YEAR',
                                                                'type' => 'string',
                                                                'multiple' => false, ), );
$iteminfo['io']['xmlrpc']['item'][] = array('orm' => array('field' => array(array('orm' => 'basic', 'field' => 'publication_month'))),
                                             'xmlrpc' => array('field' => array('creation_month'),
                                                                'display_name' => '_MD_XOONIPS_XMLRPC_DISPLAY_NAME_CREATION_MONTH',
                                                                'type' => 'string',
                                                                'multiple' => false, ), );
$iteminfo['io']['xmlrpc']['item'][] = array('orm' => array('field' => array(array('orm' => 'basic', 'field' => 'publication_mday'))),
                                             'xmlrpc' => array('field' => array('creation_mday'),
                                                                'display_name' => '_MD_XOONIPS_XMLRPC_DISPLAY_NAME_CREATION_MDAY',
                                                                'type' => 'string',
                                                                'multiple' => false, ), );
$iteminfo['io']['xmlrpc']['item'][] = array('orm' => array('field' => array(array('orm' => 'basic', 'field' => 'lang'))),
                                             'xmlrpc' => array('field' => array('lang'),
                                                                ...
                                                                'required' => true, ), );
$iteminfo['io']['xmlrpc']['item'][] = array('orm' => array('field' => array(array('orm' => 'basic', 'field' => 'item_id'))),
                                             'xmlrpc' => array('field' => array('url'),
                                                                'display_name' => '_MD_XOONIPS_XMLRPC_DISPLAY_NAME_URL',
                                                                'type' => 'string',
                                                                'readonly' => true, ),
                                             'eval' => array('orm2xmlrpc' => '$out_var[0] = XOOPS_URL . "/modules/xoonips/detail.php?item_id=" . $in_var[0];',
                                                              'xmlrpc2orm' => ';', ), );
$iteminfo['io']['xmlrpc']['item'][] = array('orm' => array('field' => array(array('orm' => 'indexes',     'field' => 'index_id'))),
                                             'xmlrpc' => array('field' => array('indexes'),
                                                                'display_name' => '_MD_XOONIPS_XMLRPC_DISPLAY_NAME_INDEXES',
                                                                'type' => 'string',
                                                                'multiple' => true,
                                                                'required' => true, ), );
$iteminfo['io']['xmlrpc']['item'][] = array('orm' => array('field' => array(array('orm' => 'related_tos', 'field' => 'item_id'))),
                                             'xmlrpc' => array('field' => array('related_to'),
