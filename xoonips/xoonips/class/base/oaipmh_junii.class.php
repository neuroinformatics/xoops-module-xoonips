...
class JUNIIHandler extends OAIPMHHandler {
	...
	function metadataFormat( $identifier = null ) {
		if( $identifier != null ){
			...
			if( !$parsed )
				return false;		//$identifier is wrong
...
echo "pubdate=" . $result['publish_date']. "set=$set count=" . var_dump($identifiers); echo "\n";
