...
class XooNIpsImportItemHandler
{
    ...
    public function _findDuplicateImportItemIds($import_item, $all_import_items,
                                         $title_item_map)
    {
        $a = false;
        ...
        foreach ($duplicate_possible as $i) {
            ...
            if (count($i->getVar('titles'))
                != count($import_item->getVar('titles'))) {
                continue;
            }
     ...
     */
    public function index_str2index_id($str, $user, $base_index_path = '/',
                                 $open_level = 'private')
    {
        global $xoopsDB;
    ...
    public function &_create_index_item_links_from_index_ids(
