...
class XNPBookImportItem extends XooNIpsImportItem{
    var $_has_book_pdf = false;
    
    function XNPBookImportItem(){
        $handler =& xoonips_getormcompohandler( 'xnpbook', 'item' );
        $this -> _item =& $handler -> create();
    }
    
    function setHasBookPdf( ){
        $this -> _has_book_pdf = true;
    }
    
    function unsetHasBookPdf( ){
...
class XNPBookImportItemHandler extends XooNIpsImportItemHandler{
     ...
     */
    var $_book_pdf_file = null;
    
    /**
     * flag of attachment file parsed
     */
    var $_book_pdf_file_flag = false;
    ...
    function XNPBookImportItemHandler(){
    ...
    function onImportFinished( &$item, &$import_items ){
        if( 'xnpbookimportitem' != strtolower( get_class($item) ) ) return;
