...
$iteminfo['orm'][] = array( 'module' => 'xnptool','name' => 'item_detail',     'field' => 'detail',      'foreign_key' => 'tool_id','multiple' => false, 'required'=>true );
$iteminfo['orm'][] = array( 'module' => 'xnptool','name' => 'developer',     'field' => 'developer',      'foreign_key' => 'tool_id','multiple' => true, 'criteria' => $developer_order_criteria );
$iteminfo['orm'][] = array( 'module' => 'xoonips', 'name' => 'file',            'field' => 'tool_data',  'foreign_key' => 'item_id', 'criteria' => iteminfo_file_criteria( 'tool_data' ), 'multiple' => false );
...
$iteminfo['ormfield']['detail'] = array( array( 'name' => 'tool_id', 'type' => 'int', 'required' => ' false' ),
                                         array( 'name' => 'tool_type', 'type' => 'string', 'required' => ' false' ),
...
$iteminfo['io']['xmlrpc']['item'][] = array( 'orm' => array( 'field' => array( array( 'orm' => 'detail', 'field' => 'tool_id' ) ) ),
                                             'xmlrpc' => array( 'field' => array( 'detail_field','tool_id' ), 
                                                                'display_name' => '_MD_XNPTOOL_XMLRPC_DISPLAY_NAME_TOOL_ID',
                                                                'type' => 'string',
                                                                'multiple' => false,
                                                                'readonly' => true ) );
$iteminfo['io']['xmlrpc']['item'][] = array( 'orm' => array( 'field' => array( array( 'orm' => 'detail', 'field' => 'tool_type' ) ) ),
                                             'xmlrpc' => array( 'field' => array( 'detail_field','tool_type' ), 
                                                                'display_name' => '_MD_XNPTOOL_XMLRPC_DISPLAY_NAME_TOOL_TYPE',
                                                                'type' => 'string',
                                                                'options' => array(
                                                                    array( 'option' => 'matlab'      , 'display_name' => '_MD_XNPTOOL_XMLRPC_DISPLAY_NAME_TOOL_TYPE_MATLAB' ),
                                                                    array( 'option' => 'mathematica' , 'display_name' => '_MD_XNPTOOL_XMLRPC_DISPLAY_NAME_TOOL_TYPE_MATHEMATICA' ),
                                                                    array( 'option' => 'program'     , 'display_name' => '_MD_XNPTOOL_XMLRPC_DISPLAY_NAME_TOOL_TYPE_PROGRAM' ),
                                                                    array( 'option' => 'other'       , 'display_name' => '_MD_XNPTOOL_XMLRPC_DISPLAY_NAME_TOOL_TYPE_OTHER' ),
                                                                 ),
                                                                'multiple' => false,
                                                                'required' => true  ) );
...
$iteminfo['io']['xmlrpc']['item'][] = array( 'orm' => array( 'field' => array( array( 'orm' => 'detail', 'field' => 'attachment_dl_notify' ) ) ),
                                             'xmlrpc' => array( 'field' => array( 'detail_field','attachment_dl_notify' ), 
                                                                ...
                                                                'type' => 'string',
                                                                'multiple' => false ) );
$iteminfo['io']['xmlrpc']['item'][] = array( 'orm' => array( 'field' => array( array( 'orm' => 'tool_data', 'field' => 'file_id' ) ) ),
                                             'xmlrpc' => array( 'field' => array( 'detail_field','tool_data' ), 
...
$iteminfo['io']['xmlrpc']['simpleitem'][] = array( 'orm' => array( 'field' => array( array( 'orm' => 'basic',    'field' => 'creation_date' ) ) ),
                                                   'xmlrpc' => array( 'field' => array( 'registration_date' ),  
                                                                      ...
                                                                      'multiple' => false ) );
$iteminfo['io']['xmlrpc']['simpleitem'][] = array( 'orm' => array( 'field' => array( array('orm' => 'titles', 'field' => 'title' ),
                                                                                     array('orm' => 'detail', 'field' => 'tool_type' ),
