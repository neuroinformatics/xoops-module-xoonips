...
<table class="outer">
  ...
  <tr>
    ...
    <td class="<{cycle name="oddeven"}>"><input type="text" name="<{$module_name}>_experimenter" value=""  size="50"/></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="<{cycle name="oddeven"}>"><input type="text" name="<{$module_name}>_data_file" value=""  size="50"/></td>
  </tr>
</table>
</div>
