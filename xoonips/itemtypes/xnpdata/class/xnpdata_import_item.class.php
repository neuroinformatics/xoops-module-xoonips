    ...
    public function xmlStartElementHandler($parser, $name, $attribs)
    {
        ...
        case 'ITEM/DETAIL/FILE':
            ...
            if ($this->_file_type_attribute == 'data_file') {
                ...
                $this->_data_file->set('original_file_name', $unicode->decode_utf8($attribs['ORIGINAL_FILE_NAME'], xoonips_get_server_charset(), 'h'));
    ...
    public function xmlEndElementHandler($parser, $name)
    {
        ...
        case 'ITEM/DETAIL/FILE':
            ...
            if ($this->_file_type_attribute == 'data_file') {
                ...
                $this->_data_file = $file_handler->get($this->_data_file->get('file_id'));
