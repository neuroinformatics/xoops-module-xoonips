...
<table class="outer">
  ...
  <tr>
    ...
    <td class="<{cycle name="oddeven"}>"><{$files_file.value}></td>
  </tr>
  <tr>
    <td class="head"><{$smarty.const._MD_XNPFILES_DATA_FILE_NAME}></td>
    <td class="<{cycle name="oddeven"}>"><{$xoonips_item.detail.data_file_name}></td>
  </tr>
  <tr>
    <td class="head"><{$smarty.const._MD_XNPFILES_DATA_FILE_MIMETYPE}></td>
    <td class="<{cycle name="oddeven"}>"><{$xoonips_item.detail.data_file_mimetype}></td>
  </tr>
  <tr>
    <td class="head"><{$smarty.const._MD_XNPFILES_DATA_FILE_FILETYPE}></td>
    <td class="<{cycle name="oddeven"}>"><{$xoonips_item.detail.data_file_filetype}></td>
  </tr>
  <tr>
...
<{if $editable }>
<{$basic.hidden}>
<input type="hidden" name="files_fileFileID" value="<{$xoonips_item.detail.files_file.file_id}>"/>
<{$index.hidden}>
<{/if}>
</form>
