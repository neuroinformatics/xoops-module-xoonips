...
class XNPPaperImportItem extends XooNIpsImportItem{
    var $_has_paper_pdf_reprint = false;
    
    function XNPPaperImportItem(){
        $handler =& xoonips_getormcompohandler( 'xnppaper', 'item' );
        $this -> _item =& $handler -> create();
    }
    
    function setHasPaperPdfReprint( ){
        $this -> _has_paper_pdf_reprint = true;
    }
    
    function unsetHasPaperPdfReprint( ){
        $this -> _has_paper_pdf_reprint = false;
    }
    
    function hasPaperPdfReprint( ){
...
class XNPPaperImportItemHandler extends XooNIpsImportItemHandler{
     ...
     */
    var $_paper_pdf_reprint_file = null;
    
    /**
     * flag of attachment file parsed
     */
    var $_paper_pdf_reprint_file_flag = false;
    ...
    function XNPPaperImportItemHandler(){
    ...
    function onImportFinished( &$item, &$import_items ){
        if( 'xnppaperimportitem' != strtolower( get_class($item) ) ) return;
