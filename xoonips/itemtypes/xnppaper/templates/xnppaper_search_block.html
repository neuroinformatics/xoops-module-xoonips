...
<table class="outer">
  ...
  <tr>
    ...
    <td class="<{cycle name="oddeven"}>"><input type="text" name="<{$module_name}>_author" value=""  size="50"/></td>
  </tr>
  <tr>
    <td class="head"><{$smarty.const._MD_XNPPAPER_JOURNAL_LABEL}></td>
    <td class="<{cycle name="oddeven"}>"><input type="text" name="<{$module_name}>_journal" value=""  size="50"/></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="<{cycle name="oddeven"}>"><input type="text" name="<{$module_name}>_volume" value=""  size="50"/></td>
  </tr>
  <tr>
    <td class="head"><{$smarty.const._MD_XNPPAPER_NUMBER_LABEL}></td>
    <td class="<{cycle name="oddeven"}>"><input type="text" name="<{$module_name}>_number" value=""  size="50"/></td>
  </tr>
  <tr>
    <td class="head"><{$smarty.const._MD_XNPPAPER_PAGE_LABEL}></td>
    <td class="<{cycle name="oddeven"}>"><input type="text" name="<{$module_name}>_page" value=""  size="50"/></td>
  </tr>
  <tr>
    <td class="head"><{$smarty.const._MD_XNPPAPER_PDF_REPRINT_LABEL}></td>
    <td class="<{cycle name="oddeven"}>"><input type="text" name="<{$module_name}>_paper_pdf_reprint" value=""  size="50"/></td>
  </tr>
</table>
</div>
