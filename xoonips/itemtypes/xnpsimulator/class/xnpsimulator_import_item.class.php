...
class XNPSimulatorImportItemHandler extends XooNIpsImportItemHandler
{
    ...
    public function xmlStartElementHandler($parser, $name, $attribs)
    {
        ...
        case 'ITEM/DETAIL/FILE':
            ...
            if ('simulator_data' == $this->_file_type_attribute) {
                ...
                $this->_simulator_data->set('original_file_name', $unicode->decode_utf8($attribs['ORIGINAL_FILE_NAME'], xoonips_get_server_charset(), 'h'));
        ...
        case 'ITEM/DETAIL/FILE':
            ...
            if ('simulator_data' == $this->_file_type_attribute) {
                ...
                if (!$file_handler->insert($this->_simulator_data)) {
                    $this->_import_item->setErrors(E_XOONIPS_DB_QUERY, "can't insert attachment file:".$this->_simulator_data->get('original_file_name').$this->_get_parser_error_at());
                }
                $this->_simulator_data = $file_handler->get($this->_simulator_data->get('file_id'));
