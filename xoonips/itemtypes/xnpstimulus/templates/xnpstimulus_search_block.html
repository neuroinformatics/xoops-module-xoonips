...
<table class="outer">
  ...
  <tr>
    ...
    <td class="<{cycle name="oddeven"}>">
     <select name="<{$module_name}>_stimulus_type">
      <option value="">Any</option>
      <{html_options options=$stimulus_type_option}>
     </select>
    </td>
  </tr>
  <tr>
    <td class="head"><{$smarty.const._MD_XNPSTIMULUS_DEVELOPER_LABEL}></td>
    <td class="<{cycle name="oddeven"}>"><input type="text" name="<{$module_name}>_developer" value=""  size="50"/></td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="head"><{$smarty.const._MD_XNPSTIMULUS_CAPTION_LABEL}></td>
