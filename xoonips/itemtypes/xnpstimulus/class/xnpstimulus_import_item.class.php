    ...
    public function xmlStartElementHandler($parser, $name, $attribs)
    {
        ...
        case 'ITEM/DETAIL/FILE':
            ...
            if ($this->_file_type_attribute == 'stimulus_data') {
                ...
                $this->_stimulus_data->set('original_file_name', $unicode->decode_utf8($attribs['ORIGINAL_FILE_NAME'], xoonips_get_server_charset(), 'h'));
    ...
    public function xmlEndElementHandler($parser, $name)
    {
        ...
        case 'ITEM/DETAIL/FILE':
            ...
            if ($this->_file_type_attribute == 'stimulus_data') {
                ...
                $this->_stimulus_data = $file_handler->get($this->_stimulus_data->get('file_id'));
