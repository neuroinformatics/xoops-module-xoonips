...
$iteminfo['orm'][] = array('module' => 'xnpstimulus', 'name' => 'item_detail', 'field' => 'detail',  'foreign_key' => 'stimulus_id', 'multiple' => false, 'required' => true);
$iteminfo['orm'][] = array('module' => 'xnpstimulus', 'name' => 'developer',     'field' => 'developer', 'foreign_key' => 'stimulus_id', 'multiple' => true, 'criteria' => $developer_order_criteria);
$iteminfo['orm'][] = array('module' => 'xoonips', 'name' => 'file',            'field' => 'stimulus_data',  'foreign_key' => 'item_id', 'criteria' => iteminfo_file_criteria('stimulus_data'), 'multiple' => false);
...
$iteminfo['ormfield']['detail'] = array(array('name' => 'stimulus_id', 'type' => 'int', 'required' => ' false'),
                                         array('name' => 'stimulus_type', 'type' => 'string', 'required' => ' false'),
...
$iteminfo['io']['xmlrpc']['item'][] = array('orm' => array('field' => array(array('orm' => 'detail', 'field' => 'stimulus_id'))),
                                             'xmlrpc' => array('field' => array('detail_field', 'stimulus_id'),
                                                                'display_name' => '_MD_XNPSTIMULUS_XMLRPC_DISPLAY_NAME_STIMULUS_ID',
                                                                'type' => 'string',
                                                                'multiple' => false,
                                                                'readonly' => true, ), );
$iteminfo['io']['xmlrpc']['item'][] = array('orm' => array('field' => array(array('orm' => 'detail', 'field' => 'stimulus_type'))),
                                             'xmlrpc' => array('field' => array('detail_field', 'stimulus_type'),
                                                                'display_name' => '_MD_XNPSTIMULUS_XMLRPC_DISPLAY_NAME_STIMULUS_TYPE',
                                                                'type' => 'string',
                                                                'options' => array(
                                                                    array('option' => 'picture', 'display_name' => '_MD_XNPSTIMULUS_XMLRPC_DISPLAY_NAME_STIMULUS_TYPE_PICTURE'),
                                                                    array('option' => 'movie', 'display_name' => '_MD_XNPSTIMULUS_XMLRPC_DISPLAY_NAME_STIMULUS_TYPE_MOVIE'),
                                                                    array('option' => 'program', 'display_name' => '_MD_XNPSTIMULUS_XMLRPC_DISPLAY_NAME_STIMULUS_TYPE_PROGRAM'),
                                                                    array('option' => 'other', 'display_name' => '_MD_XNPSTIMULUS_XMLRPC_DISPLAY_NAME_STIMULUS_TYPE_OTHER'),
                                                                 ),
                                                                'multiple' => false,
                                                                'required' => true, ), );
...
$iteminfo['io']['xmlrpc']['item'][] = array('orm' => array('field' => array(array('orm' => 'detail', 'field' => 'attachment_dl_notify'))),
                                             'xmlrpc' => array('field' => array('detail_field', 'attachment_dl_notify'),
                                                                ...
                                                                'type' => 'string',
                                                                'multiple' => false, ), );
$iteminfo['io']['xmlrpc']['item'][] = array('orm' => array('field' => array(array('orm' => 'stimulus_data', 'field' => 'file_id'))),
                                             'xmlrpc' => array('field' => array('detail_field', 'stimulus_data'),
...
$iteminfo['io']['xmlrpc']['simpleitem'][] = array('orm' => array('field' => array(array('orm' => 'basic',    'field' => 'creation_date'))),
                                                   'xmlrpc' => array('field' => array('registration_date'),
                                                                      ...
                                                                      'multiple' => false, ), );
$iteminfo['io']['xmlrpc']['simpleitem'][] = array('orm' => array('field' => array(array('orm' => 'titles', 'field' => 'title'),
                                                                                     array('orm' => 'detail', 'field' => 'stimulus_type'),
