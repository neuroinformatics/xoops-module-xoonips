...
class XNPConferenceImportItem extends XooNIpsImportItem{
    var $_has_conference_file = false;

    var $_has_conference_paper = false;

    function XNPConferenceImportItem(){
        $handler =& xoonips_getormcompohandler( 'xnpconference', 'item' );
        $this -> _item =& $handler -> create();
    }

    function setHasConferenceFile( ){
        $this -> _has_conference_file = true;
    }
    
    function unsetHasConferenceFile( ){
        $this -> _has_conference_file = false;
    }
    
    function hasConferenceFile( ){
        return $this -> _has_conference_file;
    }
    
    function setHasConferencePaper( ){
        $this -> _has_conference_paper = true;
    }
    
    function unsetHasConferencePaper( ){
        $this -> _has_conference_paper = false;
    }
    
    function hasConferencePaper( ){
...
class XNPConferenceImportItemHandler extends XooNIpsImportItemHandler{
     ...
     */
    var $_import_file_version = array( "1.00", "1.01", "1.02" );
     ...
     */
    var $_conference_file = null;
    
    /**
     * flag of attachment file parsed
     */
    var $_conference_file_flag = false;
    
    /**
     * attachment file object(XooNIpsAttachment)
     */
    var $_conference_paper = null;
    
    /**
     * flag of attachment file parsed
     */
    var $_conference_paper_flag = false;
    ...
    function XNPConferenceImportItemHandler(){
    ...
    function xmlStartElementHandler( $parser , $name , $attribs ){
        ...
        case "ITEM/DETAIL/FILE":
            ...
            }else if( $this -> _file_type_attribute == 'conference_paper' ){
    ...
    function xmlEndElementHandler( $parser ,$name ){
        ...
        case "ITEM/DETAIL/AUTHORS/AUTHOR":
            if( $this -> _detail_version != '1.01'
                && $this -> _detail_version != '1.02') break;
        ...
        case "ITEM/DETAIL/AUTHOR": 
            ...
            if( $this -> _detail_version != '1.00' ) break; 
            $authors =& $this -> _import_item ->getVar('author');
